    ...
    <div className="flex h-screen bg-zinc-50 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden lg:pl-72">
        ...
        <div className="flex-1 p-8 overflow-auto">
          <div className="text-xs text-zinc-400 mb-3">Admin - Disapproved Applicant Listings</div>
          ...
          <div className="bg-white border border-zinc-200 rounded-3xl overflow-hidden">
            ...
            {loading ? (
              <div className="text-center py-20 text-zinc-500">Loading disapproved applicants...</div>
            ) : filtered.length === 0 ? (
              <div className="text-center py-20 text-zinc-500">No disapproved applicants found.</div>
            ) : (
